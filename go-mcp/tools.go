...
type Args struct {
	Entity string         `json:"entity" jsonschema:"random_joke"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JokeDeliverySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "joke-delivery_list",
		Description: "List records from JokeDelivery. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "joke-delivery_load",
		Description: "Load a single record from JokeDelivery. " +
...
func runOp(client *sdk.JokeDeliverySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JokeDeliverySDK, name string) (sdk.JokeDeliveryEntity, error) {
	switch strings.ToLower(name) {
	case "random_joke":
		return client.RandomJoke(nil), nil
