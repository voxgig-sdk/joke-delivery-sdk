// Command JokeDelivery-mcp is an MCP server exposing the JokeDelivery
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JokeDelivery_list  — list records of an entity
//	JokeDelivery_load  — load a single record of an entity
//
