# JokeDelivery SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JokeDeliverySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JokeDeliverySDK(...) and JokeDeliverySDK.test(...) become
#      JokeDeliverySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jokedelivery_sdk"
_SDK_CLASS = "JokeDeliverySDK"
