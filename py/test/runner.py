...
class JokeDeliveryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JokeDeliveryTestRunner.getenv("JOKEDELIVERY_TEST_LIVE")
        override = JokeDeliveryTestRunner.getenv("JOKEDELIVERY_TEST_OVERRIDE")
        ...
        explain = JokeDeliveryTestRunner.getenv("JOKEDELIVERY_TEST_EXPLAIN")
