...
from jokedelivery_sdk.utility import register

# Load features
from jokedelivery_sdk.feature.base_feature import JokeDeliveryBaseFeature
from jokedelivery_sdk.features import _has_feature, _make_feature
...
class JokeDeliverySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = JokeDeliveryUtility()
        self._utility = utility

        from jokedelivery_sdk.config import shared_config
    ...
    def get_utility(self):
        return JokeDeliveryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JokeDeliverySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def RandomJoke(self, data=None) -> "RandomJokeEntity":
        ...
        from jokedelivery_sdk.entity.random_joke_entity import RandomJokeEntity
