...
from jokedelivery_sdk.core.control import JokeDeliveryControl
...
from jokedelivery_sdk.core.helpers import get_ctx_prop, to_map
...
class JokeDeliveryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, JokeDeliverySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JokeDeliveryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JokeDeliveryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JokeDeliveryError(code, msg, self)
