...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.RandomJoke()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/joke-delivery-sdk/releases)) or
...
| `punchline` | `str` | The punchline or answer part of the joke |
| `setup` | `str` | The setup or question part of the joke |
| `type` | `str` | The category or type of joke |
...
```
py/
├── jokedelivery_sdk.py         -- Main SDK module
