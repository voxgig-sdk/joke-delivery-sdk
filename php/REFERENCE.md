# JokeDelivery PHP SDK Reference

Complete API reference for the JokeDelivery PHP SDK.
...
#### `JokeDeliverySDK::test($testopts = null, $sdkopts = null)`
