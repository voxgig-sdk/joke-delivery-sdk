...
class RandomJokeDirectTest extends TestCase
{
    public function test_direct_load_random_joke(): void
    {
        $setup = random_joke_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-random_joke", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
