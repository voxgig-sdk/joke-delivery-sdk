...
// JokeDelivery SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JokeDeliverySDK::test)
...
{
    private const SDK_CLASS = 'JokeDeliverySDK';
    ...
    private const SDK_BASE = 'jokedelivery_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jokedelivery_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
