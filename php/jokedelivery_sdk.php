...
class JokeDeliverySDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = JokeDeliveryHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = JokeDeliveryHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!JokeDeliveryFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, JokeDeliveryFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return JokeDeliveryUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = JokeDeliveryHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = JokeDeliveryHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = JokeDeliveryHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new JokeDeliveryError($op . "_allow",
                "JokeDeliverySDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = JokeDeliveryHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new JokeDeliveryError("graphql_error",
                "JokeDeliverySDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function RandomJoke($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_random_joke === null) {
                $this->_random_joke = new RandomJokeEntity($this, null);
            }
            return $this->_random_joke;
        }
        return new RandomJokeEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new JokeDeliverySDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
