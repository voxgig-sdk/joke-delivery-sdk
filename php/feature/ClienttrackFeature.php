...
// JokeDelivery SDK clienttrack feature
...
class JokeDeliveryClienttrackFeature extends JokeDeliveryBaseFeature
{
    ...
    public function PostConstruct(JokeDeliveryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JokeDelivery-SDK';
