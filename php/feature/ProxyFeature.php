...
// JokeDelivery SDK proxy feature
...
class JokeDeliveryProxyFeature extends JokeDeliveryBaseFeature
{
    ...
    public function init(JokeDeliveryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JokeDeliveryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
