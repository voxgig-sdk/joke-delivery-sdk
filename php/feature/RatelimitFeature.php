...
// JokeDelivery SDK ratelimit feature
...
class JokeDeliveryRatelimitFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _acquire(JokeDeliveryContext $ctx): void
    {
    ...
    private function _track(JokeDeliveryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
