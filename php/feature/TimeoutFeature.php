...
// JokeDelivery SDK timeout feature
...
class JokeDeliveryTimeoutFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _with_timeout(JokeDeliveryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JokeDeliveryContext $_ctx, float $ms): void
    {
        $client = $this->client;
