...
// JokeDelivery SDK idempotency feature
...
class JokeDeliveryIdempotencyFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _mutating(JokeDeliveryContext $ctx): bool
    {
