...
// JokeDelivery SDK cache feature
...
class JokeDeliveryCacheFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _through(JokeDeliveryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
