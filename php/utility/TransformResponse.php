...
// JokeDelivery SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class JokeDeliveryTransformResponse
{
    public static function call(JokeDeliveryContext $ctx): mixed
    {
        ...
        $transform = JokeDeliveryHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
