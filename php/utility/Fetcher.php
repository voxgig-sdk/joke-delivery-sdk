...
// JokeDelivery SDK utility: fetcher

class JokeDeliveryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JokeDeliverySDK/1.0)';
    ...
    public static function call(JokeDeliveryContext $ctx, string $fullurl, array $fetchdef): array
    {
