...
// JokeDelivery SDK utility: make_options

class JokeDeliveryMakeOptions
{
    ...
    public static function call(JokeDeliveryContext $ctx): array
    {
        ...
        //
        // `JokeDeliverySchema::optspec()` is built from the model:
        ...
        $optspec = JokeDeliverySchema::optspec();
