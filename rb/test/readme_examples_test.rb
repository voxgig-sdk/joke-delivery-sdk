...
#      offline in seeded test mode (JokeDeliverySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "JokeDelivery_sdk.rb")
  SDK_CLASS = "JokeDeliverySDK"
