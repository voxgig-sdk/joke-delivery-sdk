...
Results: Successful response with a random joke.
...
| --- | --- | --- | --- |
| RandomJoke | `load` | `GET /random_joke` | See reference |
...
- `joke-delivery_list`: List records for an entity. No active entity supports this operation.
- `joke-delivery_load`: Load one record for an entity. Supported entities: `random_joke`.
