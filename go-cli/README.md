...
AQL-driven CLI and REPL for the JokeDelivery SDK. Positional arguments are
...
./joke-delivery-cli list random_joke
./joke-delivery-cli load 1 random_joke
./joke-delivery-cli load '{id:1}' random_joke
