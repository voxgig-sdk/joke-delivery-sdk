...
func registerSDKWords(r *eng.Registry, client *sdk.JokeDeliverySDK) {
...
func runOp(client *sdk.JokeDeliverySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
