...
// JokeDelivery SDK utility: graphql
//
...
class JokeDeliveryGraphql
{
    ...
    // equivalent.
    public static function body(JokeDeliveryContext $ctx): mixed
    {
    ...
    public static function errors(JokeDeliveryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
