...
class JokeDeliveryRbacFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _required(JokeDeliveryContext $ctx): ?string
    {
    ...
    private function _reject(JokeDeliveryContext $ctx, string $required): void
    {
    ...
    private function _track(JokeDeliveryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
