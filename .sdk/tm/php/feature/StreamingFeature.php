...
// JokeDelivery SDK streaming feature
...
class JokeDeliveryStreamingFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _iterate(JokeDeliveryResult $result): \Generator
    {
    ...
    private function _streamable(JokeDeliveryContext $ctx): bool
    {
