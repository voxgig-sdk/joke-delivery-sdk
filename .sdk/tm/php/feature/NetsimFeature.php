...
// JokeDelivery SDK netsim feature
...
class JokeDeliveryNetsimFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _simulate(JokeDeliveryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JokeDeliveryContext $ctx, array $applied): void
    {
        $client = $this->client;
