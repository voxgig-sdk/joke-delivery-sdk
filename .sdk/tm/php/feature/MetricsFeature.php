...
// JokeDelivery SDK metrics feature
...
class JokeDeliveryMetricsFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _record(JokeDeliveryContext $ctx, bool $ok): void
    {
