...
// JokeDelivery SDK audit feature
...
class JokeDeliveryAuditFeature extends JokeDeliveryBaseFeature
{
    ...
    private function _emit(JokeDeliveryContext $ctx, string $outcome): void
    {
