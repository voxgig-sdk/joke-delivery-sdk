...
// JokeDelivery SDK utility type

class JokeDeliveryUtility
{
    ...
    public static function copy(JokeDeliveryUtility $src): JokeDeliveryUtility
    {
        $u = new JokeDeliveryUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
