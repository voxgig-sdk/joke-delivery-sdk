...
// JokeDelivery SDK pipeline test
//
...
{
    private static function utility(): JokeDeliveryUtility
    {
        return new JokeDeliveryUtility();
    }
    ...
    private static function ctx(array $over = []): JokeDeliveryContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new JokeDeliveryContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new JokeDeliveryOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof JokeDeliveryError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new JokeDeliveryOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = JokeDeliveryMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new JokeDeliveryOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = JokeDeliveryMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new JokeDeliveryOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = JokeDeliveryMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JokeDeliverySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = JokeDeliveryMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new JokeDeliveryResponse([]),
            'result' => new JokeDeliveryResult([]),
        ]);
        [, $err] = JokeDeliveryMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec([]),
            'response' => null,
            'result' => new JokeDeliveryResult([]),
        ]);
        [, $err] = JokeDeliveryMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec(['step' => 's']),
            'response' => new JokeDeliveryResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new JokeDeliveryResult([]),
        ]);
        [, $err] = JokeDeliveryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec(['step' => 's']),
            'response' => new JokeDeliveryResponse(self::resp(200, ['v' => 1])),
            'result' => new JokeDeliveryResult([]),
        ]);
        [, $err] = JokeDeliveryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec(['step' => 's']),
            'response' => new JokeDeliveryResponse(self::resp(200, ['v' => 2])),
            'result' => new JokeDeliveryResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        JokeDeliveryMakeResponse::call($ctx);
    ...
    {
        $preset = new JokeDeliveryResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec([]),
            'response' => new JokeDeliveryResponse([]),
            'result' => new JokeDeliveryResult([]),
        ...
        [$got, $err] = JokeDeliveryMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new JokeDeliveryResult([])]);
        [, $err] = JokeDeliveryMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new JokeDeliverySpec([]), 'result' => null]);
        [, $err] = JokeDeliveryMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JokeDeliverySpec(['step' => 's']),
            'result' => new JokeDeliveryResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new JokeDeliveryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JokeDeliveryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JokeDeliverySpec(['step' => 's']),
            'result' => new JokeDeliveryResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new JokeDeliveryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JokeDeliveryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JokeDeliveryResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new JokeDeliverySpec([]),
            'result' => new JokeDeliveryResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = JokeDeliveryMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JokeDeliveryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new JokeDeliveryError('boom', 'boom');
        $utility->fetcher = function (JokeDeliveryContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JokeDeliverySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = JokeDeliveryMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (JokeDeliveryContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = JokeDeliveryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(JokeDeliveryResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        JokeDeliveryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (JokeDeliveryContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JokeDeliverySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = JokeDeliveryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new JokeDeliveryResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new JokeDeliverySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = JokeDeliveryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = JokeDeliveryMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = JokeDeliveryMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new JokeDeliveryResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, JokeDeliveryDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new JokeDeliveryResult(['ok' => false])]);
        $this->expectException(JokeDeliveryError::class);
        JokeDeliveryDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new JokeDeliveryResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', JokeDeliveryMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        JokeDeliveryMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new JokeDeliveryBaseFeature();
        $b = new JokeDeliveryBaseFeature();
        JokeDeliveryFeatureAdd::call($ctx, $a);
        JokeDeliveryFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): JokeDeliveryBaseFeature
    {
        $f = new JokeDeliveryBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        JokeDeliveryFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): JokeDeliveryContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new JokeDeliverySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JokeDeliveryPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        JokeDeliveryPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new JokeDeliveryResponse(['headers' => null]),
            'result' => new JokeDeliveryResult([]),
        ]);
        JokeDeliveryResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        JokeDeliveryResultBody::call($ctx);
