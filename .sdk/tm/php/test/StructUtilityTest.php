...
// JokeDelivery SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JokeDeliveryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JokeDeliveryOmni::structfix($now, Struct::undef()))
                        !== json_encode(JokeDeliveryOmni::structfix($val, Struct::undef()))) {
