...
|---|---|---|
| `ts/` | @voxgig-sdk/joke-delivery-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/joke-delivery-sdk \
      --repository voxgig-sdk/joke-delivery-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/joke-delivery-sdk` shows it, and
`npm trust revoke @voxgig-sdk/joke-delivery-sdk --id=<id>` removes it.
