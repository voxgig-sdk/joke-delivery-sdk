...
This API provides random jokes, making it easy for developers to integrate humor into their applications.

Learn more about Joke Delivery API at [official-joke-api.appspot.com](https://official-joke-api.appspot.com).
...
This SDK exposes the API as a small set of **semantic entities** — RandomJoke — that you
