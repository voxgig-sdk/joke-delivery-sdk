...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/joke-delivery` | `npm install @voxgig-sdk/joke-delivery` |
| Python | `voxgig-sdk-joke-delivery` | `pip install voxgig-sdk-joke-delivery` |
| PHP | `voxgig-sdk/joke-delivery` | `composer require voxgig-sdk/joke-delivery` |
| Golang | `github.com/voxgig-sdk/joke-delivery-sdk/go` | `go get github.com/voxgig-sdk/joke-delivery-sdk/go` |
| Ruby | `voxgig-sdk-joke-delivery` | `gem install voxgig-sdk-joke-delivery` |
| Lua | `voxgig-sdk-joke-delivery` | `luarocks install voxgig-sdk-joke-delivery` |
