# JokeDelivery Golang SDK Reference

Complete API reference for the JokeDelivery Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *JokeDeliverySDK`
...
#### `RandomJoke(data map[string]any) JokeDeliveryEntity`

Create a new `RandomJoke` entity instance. Pass `nil` for no initial data.
