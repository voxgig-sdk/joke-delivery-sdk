...
func (sdk *JokeDeliverySDK) OptionsMap() map[string]any {
...
func (sdk *JokeDeliverySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JokeDeliverySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JokeDeliverySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JokeDeliverySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JokeDeliverySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JokeDeliverySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JokeDeliverySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JokeDeliverySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JokeDeliverySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JokeDeliverySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *JokeDeliverySDK {
	...
	sdk := NewJokeDeliverySDK(sdkopts)
	sdk.Mode = "test"
