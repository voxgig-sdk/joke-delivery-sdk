...
function runner.env_override(m)
  local live = runner.getenv("JOKEDELIVERY_TEST_LIVE")
  local override = runner.getenv("JOKEDELIVERY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JOKEDELIVERY_TEST_EXPLAIN")
