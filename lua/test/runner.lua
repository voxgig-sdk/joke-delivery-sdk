...
function runner.env_override(m)
  local live = runner.getenv("JOKE_DELIVERY_TEST_LIVE")
  local override = runner.getenv("JOKE_DELIVERY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JOKE_DELIVERY_TEST_EXPLAIN")
