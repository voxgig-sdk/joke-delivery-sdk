...
describe("RandomJokeDirect", function()
  it("should direct-load-random_joke", function()
    local setup = random_joke_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-random_joke", setup.live and "live" or "unit")
...
function random_joke_direct_setup(mockres)
