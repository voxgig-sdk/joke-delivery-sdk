...
function envOverride(m) {
    if ('TRUE' === process.env.JOKE_DELIVERY_TEST_LIVE ||
        'TRUE' === process.env.JOKE_DELIVERY_TEST_OVERRIDE) {
    ...
    m.JOKE_DELIVERY_TEST_EXPLAIN = process.env.JOKE_DELIVERY_TEST_EXPLAIN || m.JOKE_DELIVERY_TEST_EXPLAIN;
    return m;
}
