...
(0, node_test_1.describe)('RandomJokeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.JokeDeliverySDK({
    ...
    (0, node_test_1.test)('direct-load-random_joke', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-random_joke', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.JOKE_DELIVERY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JokeDeliverySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['JOKE_DELIVERY_TEST_RANDOM_JOKE_ENTID'];
    ...
    const client = new __1.JokeDeliverySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RandomJokeDirect.test.js.map